...
def eventos_get_config_data():
    ...
    config_data["Start DateTime"] = pd.to_datetime(config_data["Start Date"]+" "+config_data["Start Time"],format="%d/%m/%Y %H:%M:%S")
    config_data["End DateTime"]   = pd.to_datetime(config_data["End Date"]+" "+config_data["End Time"],format="%d/%m/%Y %H:%M:%S")
